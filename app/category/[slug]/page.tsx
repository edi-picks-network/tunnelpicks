...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  CRM: "VPN (Virtual Private Network) services help protect your online privacy, encrypt your internet traffic, and bypass geo-restrictions. Compare the best VPN services for your needs.",
