            ...
            <div className="bg-[#0F1D32] border border-[#1E3A5F] rounded-xl p-6">
              ...
              <div className="space-y-2">
                <p className="text-sm text-[#8BA3BE]">
                  ...
                  <br />
                  <a href="mailto:support@tunnelpicks.net" className="text-[#3B82F6] hover:underline">
                    support@tunnelpicks.net
                  </a>
                </p>
                <p className="text-sm text-[#8BA3BE]">
                  <strong className="text-[#F0F4F8]">General:</strong>
                  <br />
                  <a href="mailto:info@tunnelpicks.net" className="text-[#3B82F6] hover:underline">
                    info@tunnelpicks.net
                  </a>
                </p>
                <p className="text-sm text-[#8BA3BE]">
