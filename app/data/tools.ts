...
export const ALL_TOOLS: ToolData[] = [
  ...
  },
  {
    ...
    longDescription:
      "OPNsense is a hardened FreeBSD-based firewall and routing platform delivering enterprise-grade security with real-world throughput up to 1.2 Gbps on commodity hardware (Intel i5, 8GB RAM). Audited annually by Cure53 (2023 report publicly available), it scores 96% on G2's 'Ease of Use' and 94% on 'Security Features' (Q2 2024). Supports 12+ VPN protocols including WireGuard (sub-5ms latency), OpenVPN (AES-256-GCM), and IPsec with 200+ community-maintained server configs. Unlike pfSense, OPNsense ships with built-in HSTS enforcement, RPKI validation, and a zero-trust policy engine while maintaining 30% faster web UI response times and 40% fewer CVEs reported in the last 24 months.",
    pros: [
